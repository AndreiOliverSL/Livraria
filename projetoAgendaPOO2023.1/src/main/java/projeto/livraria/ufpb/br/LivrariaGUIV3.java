...
import br.ufpb.dcx.agenda.AgendaAddController;
import br.ufpb.dcx.agenda.AgendaAyla;
...
public class LivrariaGUIV3 extends JFrame{
    ...
    public LivrariaGUIV3(){
        ...
        botaoPesquisar.addActionListener(new LivrariaSearchController(agenda, this));
        botaoRemover = new JButton("Remover",removeImg);
        botaoRemover.addActionListener(new LivrariaRemoveController(agenda, this));
